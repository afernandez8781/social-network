	...
	<div class="card border-0 mb-3 shadow-sm">
		...
		<div class="card-footer">
			<div v-for="comment in comments" class="mb-3">
				<div class="d-flex">
					<img class="rounded-circle shadow-sm mr-2" height="34px" width="34px" :src="comment.user_avatar" :alt="comment.user_name">
			...
			<form @submit.prevent="addComment" v-if="isAuthenticated">
				<div class="d-flex align-items-center">
					<img class="rounded-circle shadow-sm mr-2" width="34px" 
						src="https://avatars0.githubusercontent.com/u/33205904?s=400&u=388b4a2754a037d598d2bec4e42a7da102427768&v=4"
